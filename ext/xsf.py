...
def read_xsf(xsfile):
    ...
    """
    atoms = read(xsfile, format="xsf", parallel=False)
    # ase assumes xsf forces are in atomic units,
    # but we always use eV and Angstroms in aenet.
    atoms.calc.results['forces'] /= Ha
